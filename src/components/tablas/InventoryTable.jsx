...
const InventoryTable = ({ nombrePersonal, onEquipoSeleccionado }) => {
  ...
  return (
    <>
      <div className="bg-white shadow-md rounded-lg p-4 mt-4 overflow-hidden">
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-[1200px] w-full border border-gray-300 rounded-lg text-sm">
                <thead className="bg-gray-100">
                  <tr className="text-left">
                    ...
                    <th className="p-2 border">Asignación</th>
      ...
      <div className="bg-white shadow-md rounded-lg p-4 mt-4">
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-[900px] w-full border border-gray-300 rounded-lg text-sm">
                <thead className="bg-gray-100">
                  <tr className="text-left">
                    <th className="p-2 border">#</th>
                    <th className="p-2 border">Código</th>
