      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          <Text>
            ...
            , {formatFecha(fechaEntrega)} , declaro recibir a plena conformidad
            lo siguiente:
          </Text>
        </View>
        ...
        <View style={styles.section}>
          <Text style={styles.textParrafo}>
            <Text>
              Declaro que los equipos y accesorios que recibo de la oficina de{" "}
            </Text>
            <Text style={[styles.bold, { textDecoration: "underline" }]}>
              {areaResponsable}
            </Text>
        ...
        <View style={styles.section}>
          <Text style={styles.textParrafo}>
            Asimismo, declaro y asumo plena responsabilidad por su uso y
            cuidado, señalando que dichos bienes se dedicaran en forma exclusiva
            para desarrollar y cumplir con las labores encomendadas por la
            empresa{" "}
            <Text style={[styles.bold, { textDecoration: "underline" }]}>
              {nombreEmpresa}
            </Text>
            . Además, en caso de perdida, robo o generar algún daño por descuido
            mío, me comprometo a pagar el precio integro de los equipos
            asignados a mi persona.
          </Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.textParrafo}>
            ...
            , en la fecha en que se me indique o cuando haya culminado mi
